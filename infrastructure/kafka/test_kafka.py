...
class KafkaTestSuite:
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            self.log(
                f"Connected successfully! Found {len(cluster_metadata)} topics",
                "SUCCESS",
            )
            admin.close()
            return True
        except Exception as e:
            self.log(f"Connection failed: {e!s}", "ERROR")
            return False
    ...
    def create_topic(self) -> bool:
        ...
        try:
            ...
            topic = NewTopic(
                name=self.test_topic, num_partitions=3, replication_factor=1
            )
            ...
            self.log(f"Failed to create topic: {e!s}", "ERROR")
            return False
        ...
        try:
            ...
            for i in range(num_messages):
                ...
                try:
                    ...
                    self.log(f"Failed to send message {i}: {e!s}", "ERROR")

            producer.flush()
            producer.close()

            self.log(
                f"Producer test complete: {success_count}/{num_messages} messages sent",
                "SUCCESS",
            )
            return success_count == num_messages

        except Exception as e:
            self.log(f"Producer test failed: {e!s}", "ERROR")
            return False
    ...
    def test_consumer(self, timeout: int = 30) -> bool:
        ...
        try:
            ...
            if message_count > 0:
                self.log(
                    f"Consumer test complete: {message_count} messages received",
                    "SUCCESS",
                )
                return True
            ...
            self.log(f"Consumer test failed: {e!s}", "ERROR")
            return False
    ...
    def test_large_message(self, size_mb: float = 5.0) -> bool:
        ...
        try:
            ...
            self.log(
                f"Large message sent successfully to partition {record_metadata.partition}",
                "SUCCESS",
            )
            ...
            for msg in consumer:
                if msg.value.get("id") == "large-message-test":
                    self.log(
                        f"Large message received successfully (size: {len(str(msg.value))} bytes)",
                        "SUCCESS",
                    )
                    consumer.close()
                    return True
            ...
            self.log(f"Large message test failed: {e!s}", "ERROR")
            return False
    ...
    def test_partitions(self) -> bool:
        ...
        try:
            ...
            self.log(
                f"Messages distributed across {len(partition_counts)} partitions:",
                "SUCCESS",
            )
            ...
            self.log(f"Partition test failed: {e!s}", "ERROR")
            return False
    ...
    def list_topics(self) -> bool:
        ...
        try:
            ...
            self.log(f"Failed to list topics: {e!s}", "ERROR")
            return False
    ...
    def run_all_tests(self):
        ...
        for test_name, test_func in tests:
            ...
            try:
                ...
                self.log(f"Test crashed: {e!s}", "ERROR")
                failed += 1
...
if __name__ == "__main__":
    ...
    print(
        f"Using Kafka bootstrap servers: {bootstrap_servers or DEFAULT_BOOTSTRAP_SERVERS}"
    )
